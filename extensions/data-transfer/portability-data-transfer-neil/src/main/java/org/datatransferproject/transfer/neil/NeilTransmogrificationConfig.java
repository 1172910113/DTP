...
// This class defines transmogrification paramaters for Neil imports
public class NeilTransmogrificationConfig extends TransmogrificationConfig {
  /** Neil has forbidden characters for file names */
