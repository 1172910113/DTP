...
public class NeilPhotosImporterTest {
  ...
  public void setUp() throws Exception {
    ...
    importer = new NeilPhotosImporter(clientFactory, monitor, jobStore);
  ...
  public void testImportItemFromURL() throws Exception {
    ...
    verify(resource).transmogrify(any(NeilTransmogrificationConfig.class));
