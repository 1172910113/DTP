...
// This class defines transmogrification paramaters for Pod imports
public class PodTransmogrificationConfig extends TransmogrificationConfig {
  /** Pod has forbidden characters for file names */
